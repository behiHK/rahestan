...
const BuildingProjects = () => {
   ...
   return (
    <div className='bg-white w-full py-10'>
        <p className='text-2xl lg:text-3xl text-gray-500 text-right pr-10 py-10'>  ساختمان اداری پارک زیست فناوری خلیج فارس</p>
        ...
        <p className='text-2xl lg:text-3xl text-gray-500 text-right pr-10 py-10'> مجتمع اقامتی رفاهی میلاد جم</p>
        <div className='flex flex-col md:grid md:gap-0 md:grid-cols-4 md:grid-rows-2 gap-0 place-items-stretch'>
        ...
        <p className='text-2xl lg:text-3xl text-gray-500 text-right pr-10 py-10'>مجتمع اقامتی رفاهی کنگان </p>
        <div className='flex flex-col md:grid md:gap-0 md:grid-cols-3 md:grid-rows-4 gap-0 place-items-stretch'>
        ...
        <p className='text-2xl lg:text-3xl text-gray-500 text-right pr-10 py-10'> ساختمان ایستگاه راه آهن سبا</p>
        <div className='flex flex-col md:grid md:gap-0 md:grid-cols-2 md:grid-rows-1 gap-0 place-items-stretch'>
            <img src={image21} className='col-start-1'/>
            <img src={image22} className='col-start-2'/>
        </div>

        <p className='text-2xl lg:text-3xl text-gray-500 text-right pr-10 py-10'>سازمان حج و زیارت تهران</p>
        ...
        <p className='text-2xl lg:text-3xl text-gray-500 text-right pr-10 py-10'> ساختمان ابزار دقیق و اتوماسیون فولاد مبارکه</p>
        <div className='flex flex-col md:grid md:gap-0 md:grid-cols-2 md:grid-rows-1 gap-0 place-items-stretch'>
