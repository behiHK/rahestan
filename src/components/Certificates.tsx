...
const Certificates = () => {
    const intl = useIntl()
    return (
        <div className={`w-full min-h-[50vh] ${intl.locale === "fa" ? "text-right" : "text-left"}`}>
             <p className='text-2xl lg:text-3xl text-gray-500 px-10 py-10'> {intl.formatMessage({id: "certificates"})}</p>
            <div className='flex flex-col md:grid md:gap-0 md:grid-cols-4 md:grid-rows-2 md:gap-4 place-items-stretch mb-10'>
            ...
            <div className='flex flex-col md:grid md:gap-0 md:grid-cols-5 md:grid-rows-2 md:gap-4 place-items-stretch  mb-20'>
                <img src={image6}  className='col-start-2'/>
                <img src={image7} className='col-start-3'/>
                <img src={image8} className='col-start-4'/>
                <img src={image10} className='col-start-2'/>
                <img src={image9} className='col-start-3 col-span-2'/>
            </div>
        </div> 
    )
}
